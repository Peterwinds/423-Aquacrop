...
-- Dumping database structure for winds_test
CREATE DATABASE IF NOT EXISTS `winds_test` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `winds_test`;
...
-- Dumping data for table winds_test.aquacrop_crop_table: ~4 rows (approximately)
